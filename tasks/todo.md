...
- [ ] **2. Apps Script + owner setup guide**
...
- [ ] **CP1** — all unit tests and the node test pass. Commit.
...
- [ ] **CP2** — **you:** deploy the test sheet script and send me the URL. Full flow on a real phone. Check Success Criteria 1–9 and 11–13.

- [ ] **10. QR option in Settings**
